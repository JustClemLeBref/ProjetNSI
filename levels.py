...
def main():
    ...
    full_hearts = pygame.image.load('.\\GRAPHISME\\LifeBarFULL.png')
    full_hearts=pygame.transform.scale(full_hearts, (500,500))
    two_hearts = pygame.image.load('.\\GRAPHISME\\LifeBar2.png')
    two_hearts=pygame.transform.scale(two_hearts, (500,500))
    one_hearts = pygame.image.load('.\\GRAPHISME\\LifeBar1.png')
    one_hearts=pygame.transform.scale(one_hearts, (500,500))
    ...
    while active:
        ...
        screen.blit(full_hearts,(0,0))
        if hearts == 1:
            screen.blit(two_hearts,(0,0))
        if hearts == 0:
            screen.blit(one_hearts,(0,0))
